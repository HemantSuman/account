...
var modelName = 'City';
var viewDirectory = 'cities';
var titleName = 'Add new City';
...
router.post('/citiesById', function(req, res, next) {
  req.where = {state_id: req.body.id};
  models[modelName].getValuesByState(req, function (results) {
    res.json(results);
