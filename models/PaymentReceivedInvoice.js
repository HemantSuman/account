...
module.exports = function (sequelize, DataTypes) {
  var myModel = sequelize.define("PaymentReceivedInvoice",
    {
        invoice_id: {
    ...
    {
      tableName: 'payments_received_invoices',
  });  
  myModel.getAllValues = function (req, res) {
    req.where.company_id = req.siteVariable.session.user.Company.id;
    var accountToPayment = myModel.belongsTo(sequelize.models.Account, {foreignKey: 'consignee_no'});
